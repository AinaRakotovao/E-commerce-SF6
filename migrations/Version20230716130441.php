 ...
 */
final class Version20230716130441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orderes_details (orders_id INT NOT NULL, products_id INT NOT NULL, quantity INT NOT NULL, price INT NOT NULL, INDEX IDX_8F3DB729CFFE9AD6 (orders_id), INDEX IDX_8F3DB7296C8A81A9 (products_id), PRIMARY KEY(orders_id, products_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE orderes_details ADD CONSTRAINT FK_8F3DB729CFFE9AD6 FOREIGN KEY (orders_id) REFERENCES orders (id)');
        $this->addSql('ALTER TABLE orderes_details ADD CONSTRAINT FK_8F3DB7296C8A81A9 FOREIGN KEY (products_id) REFERENCES products (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orderes_details DROP FOREIGN KEY FK_8F3DB729CFFE9AD6');
        $this->addSql('ALTER TABLE orderes_details DROP FOREIGN KEY FK_8F3DB7296C8A81A9');
        ...
        $this->addSql('DROP TABLE orderes_details');
